...
// 🍽 Uploader para imágenes de Restaurantes
export const uploadRestaurantImage = createCloudinaryUploader(
    process.env.CLOUDINARY_RESTAURANTS_FOLDER || 'kinal_restaurants/restaurants'
);

// 🍔 Uploader para imágenes de Platillos
export const uploadDishImage = createCloudinaryUploader(
    process.env.CLOUDINARY_DISHES_FOLDER || 'kinal_restaurants/dishes'
);
